...
import logostill from "../assets/logo192.png";
        ...
        <Grid container className={classes.navContainer} alignItems="center">
          <Grid item sm={12} md={8}>
            ...
            <div className={classes.title}>
              <span className={classes.title}>scUSDC Vault</span>
              <span className={classes.subtitle}>
                USDC returns with leveraged ETH Staking
              </span>
            </div>
          </Grid>
          <Grid item sm={12} md={4} className={classes.accountItem}>
            <Button
              ...
              variant={walletAddress ? "text" : "contained"}
